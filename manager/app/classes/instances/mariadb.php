...
return (new class() extends Instance
{
	...
	public function install()
	{
		...
		Util::exec($this->path.'\\bin\\mysql_install_db.exe --datadir='.$datadir);
		...
		$this->installer->startTask();
		# delete included data dir
		Util::deltree($this->path.'\\data');
	...
	public function start()
	{
		if (Util::serviceExists($this->service_name))
			...
			Util::background($this->process_name.' --standalone --console');
