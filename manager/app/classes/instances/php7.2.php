...
return (new class() extends Instance
{
	...
	public function install()
	{
		...
		$data = str_replace('extension=opcache', 'zend_extension=opcache',                         			$data);
